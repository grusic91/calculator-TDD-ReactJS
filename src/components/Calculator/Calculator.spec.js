...
describe('Calculator', () => {
    ...
    it('should render correcty', () => expect(wrapper).toMatchSnapshot());
...
describe('callOperator', () => {
    ...
    it('updates displayValue to "0" if operation result in "Infinity"', () => {
    ...
    it('updates displayValue to "0" if called with no value of storedValue or selectedOperator', () => {
